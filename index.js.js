...
//const uri = "mongodb+srv://quan2000:quanlklk75@cluster0-lucf7.mongodb.net/<ShopOnline>?retryWrites=true&w=majority";
/// ***************** ***************** *****************
...
/// ***************** ***************** *****************
// Đây là cái URL khi nhập vào nó sẽ return ra 1 cái View (staffs)
// và view trong trường hợp này là cái trang này "stafflist"
// hiểu chưa ?
...
/// ***************** ***************** *****************
app.get('/products/:stt', viewProducts);
function viewProducts(request, response) {
	// request.params.stt;
